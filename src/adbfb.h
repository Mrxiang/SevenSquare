...
#define SYS_TEMP            "cat /sys/devices/virtual/thermal/thermal_zone0/temp"
#define SYS_PASSIVE_TEMP            "cat /sys/devices/virtual/thermal/thermal_zone0/trip_point_0_temp"
#define SYS_CRITICAL_TEMP            "cat /sys/devices/virtual/thermal/thermal_zone0/trip_point_1_temp"
#define SYS_GOVERNOR            "cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor"
...
private:
    ...
    //xshx add
    int  probeDeviceInformation(void);
...
private:
    ...
    //xshx add
    int printTemp(QByteArray &bytes, int offset = 0);
